...
HD_PWD='C:/Users/celia/Desktop/Archivo_Celia/ETSIDI/19-20/1cuatri/SED/TRABAJOS/VHDL/CLAVE_SECRETA_v2/CLAVE_SECRETA_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Clave_secret_v2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Clave_secret_v2.tcl
