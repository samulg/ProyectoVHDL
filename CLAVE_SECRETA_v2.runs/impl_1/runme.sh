...
HD_PWD='C:/Users/celia/Desktop/Archivo_Celia/ETSIDI/19-20/1cuatri/SED/TRABAJOS/VHDL/CLAVE_SECRETA_v2/CLAVE_SECRETA_v2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Clave_secret_v2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Clave_secret_v2.tcl -notrace
